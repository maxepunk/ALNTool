  ...
  return (
    <div
      ...
      style={{
        ...
        height: nodeSize,
        borderRadius: '50%',
        border: `${visualState.isSelected ? 3 : 2}px solid ${visualState.isSelected ? '#2196f3' : visualState.isConnected ? '#64b5f6' : '#90caf9'}`,
        backgroundColor: isBackground ? '#1a1a1a' : '#2d2d2d',
